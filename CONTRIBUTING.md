...
issue](https://github.com/cisagov/cool-master-cur/issues) in this
...
request](https://github.com/cisagov/cool-master-cur/pulls), you
...
```console
cd cool-master-cur
pyenv virtualenv <python_version_to_use> cool-master-cur
pyenv local cool-master-cur
